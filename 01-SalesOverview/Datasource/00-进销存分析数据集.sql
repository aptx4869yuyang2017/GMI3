...
SELECT  t1.fiscal_year
       ...
       ,t1.stock_gsv_incl_promotion
       ,t1.stock_case_latest
       ,t1.stock_gsv_latest
       ...
       ,t1.stock_gsv_latest_ly
       ,t1.days_of_next_fiscal_month
...
AND not (nvl(product_category_name,'') = '冰淇淋' AND business_area_name = '餐饮')
